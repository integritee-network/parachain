...
import {
    ...
    DOT_FROM_POLKADOT_PARACHAINS, DOT_FROM_SIBLING_PARACHAINS,
    DOT_UNITS,
    IK_PARA_ID, IP_PARA_ID,
    ITK_FROM_COUSIN,
    ITK_FROM_SIBLING,
    ITP_FROM_COUSIN, ITP_FROM_SIBLING, KAH_FROM_COUSIN, KAH_FROM_KUSAMA_PARACHAINS,
    KAH_FROM_POLKADOT_PARACHAINS,
    KAH_FROM_SIBLING, KAH_PARA_ID,
    KSM_FROM_COUSIN_PARACHAINS, KSM_FROM_KUSAMA_PARACHAINS, KSM_FROM_POLKADOT_PARACHAINS,
    KSM_FROM_SIBLING_PARACHAINS, KSM_UNITS, PAH_FROM_COUSIN,
    PAH_FROM_KUSAMA_PARACHAINS,
    PAH_FROM_POLKADOT_PARACHAINS, PAH_FROM_SIBLING,
    PAH_PARA_ID,
    TEER_FROM_SELF,
