...
if [ -z "$FRAMEWORK_REPO_PATH" ]; then
  ...
  git fetch --tags
  git checkout 7d875655ea38b734d6f1a3a79aef227e846f227c # need a recent fix https://github.com/paritytech/polkadot-sdk/pull/8900
  popd
else
...
export INTEGRITEE_PARACHAIN_BINARY=$LOCAL_BRIDGE_TESTING_PATH/bin/integritee-collator
