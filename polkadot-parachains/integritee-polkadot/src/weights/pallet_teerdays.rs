...
// --extrinsic=*
// --heap-pages=4096
// --output=./polkadot-parachains/integritee-kusama/src/weights/pallet_teerdays.rs
...
impl<T: frame_system::Config> pallet_teerdays::WeightInfo for WeightInfo<T> {
	...
	fn bond() -> Weight {
		...
		//  Measured:  `344`
		//  Estimated: `4764`
		// Minimum execution time: 53_603_000 picoseconds.
		Weight::from_parts(55_328_000, 0)
	...
	fn withdraw_unbonded() -> Weight {
		...
		Weight::from_parts(55_183_000, 0)
			.saturating_add(Weight::from_parts(0, 4764))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(3))
	}
