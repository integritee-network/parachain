...
impl<T: frame_system::Config> pallet_enclave_bridge::WeightInfo for WeightInfo<T> {
	...
	fn shield_funds() -> Weight {
		...
		Weight::from_parts(66_917_000, 0)
	...
	fn unshield_funds() -> Weight {
		...
		//  Measured:  `511`
		//  Estimated: `6196`
		// Minimum execution time: 99_117_000 picoseconds.
		Weight::from_parts(102_005_000, 0)
	...
	fn publish_hash(_l: u32, t: u32, ) -> Weight {
		...
		Weight::from_parts(34_609_300, 0)
			.saturating_add(Weight::from_parts(0, 3873))
			// Standard Error: 25_547
			.saturating_add(Weight::from_parts(2_193_112, 0).saturating_mul(t.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn purge_enclave_from_shard_status() -> Weight {
		...
		Weight::from_parts(22_186_000, 0)
