...
// --extrinsic=*
// --heap-pages=4096
// --output=./polkadot-parachains/integritee-kusama/src/weights/cumulus_pallet_parachain_system.rs
...
impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for WeightInfo<T> {
	...
	fn enqueue_inbound_downward_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(471_536_376, 0)
			.saturating_add(Weight::from_parts(0, 3517))
			// Standard Error: 69_133
			.saturating_add(Weight::from_parts(119_164_098, 0).saturating_mul(n.into()))
