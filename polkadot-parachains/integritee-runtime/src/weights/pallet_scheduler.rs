...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(21_069_120, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 72_290
			.saturating_add(Weight::from_parts(1_311_090, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_268_835, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 3_416
			.saturating_add(Weight::from_parts(714_822, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: Scheduler Agenda (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_262_448, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 3_678
			.saturating_add(Weight::from_parts(1_318_388, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(18_364_770, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 3_947
			.saturating_add(Weight::from_parts(794_277, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Scheduler Lookup (r:1 w:1)
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_704_325, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 3_519
			.saturating_add(Weight::from_parts(1_350_999, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}
