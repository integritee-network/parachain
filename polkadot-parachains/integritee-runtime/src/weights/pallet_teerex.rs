...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_sgx_enclave() -> Weight {
		...
		Weight::from_parts(3_057_351_000, 0)
	...
	fn register_quoting_enclave() -> Weight {
		...
		//  Measured:  `132`
		//  Estimated: `1493`
		// Minimum execution time: 1_356_417_000 picoseconds.
		Weight::from_parts(1_363_262_000, 0)
	...
	fn register_tcb_info() -> Weight {
		...
		//  Measured:  `132`
		//  Estimated: `1493`
		// Minimum execution time: 1_376_167_000 picoseconds.
		Weight::from_parts(1_421_038_000, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
