...
impl<T: frame_system::Config> pallet_teerex::WeightInfo for WeightInfo<T> {
	...
	fn register_sgx_enclave() -> Weight {
		...
		//  Measured:  `784`
		//  Estimated: `4249`
		// Minimum execution time: 2_772_309_000 picoseconds.
		Weight::from_parts(2_920_097_000, 0)
	...
	fn register_quoting_enclave() -> Weight {
		...
		//  Measured:  `132`
		//  Estimated: `1493`
		// Minimum execution time: 1_378_427_000 picoseconds.
		Weight::from_parts(1_385_370_000, 0)
	...
	fn register_tcb_info() -> Weight {
		...
		//  Measured:  `132`
		//  Estimated: `1493`
		// Minimum execution time: 1_462_220_000 picoseconds.
		Weight::from_parts(1_475_369_000, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
